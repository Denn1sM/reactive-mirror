...
const _Navigation = _interopRequireDefault(require('./Calendar/Navigation'));

const _CenturyView = _interopRequireDefault(require('./CenturyView'));

const _DecadeView = _interopRequireDefault(require('./DecadeView'));

const _YearView = _interopRequireDefault(require('./YearView'));

const _MonthView = _interopRequireDefault(require('./MonthView'));
...
function getDetailValue(_ref, index) {
  ...
  const detailValueFrom = [_dates.getBegin, _dates.getEnd][index](valueType, valuePiece);
...
const Calendar = /* #__PURE__ */(function (_Component) {
  ...
  function Calendar() {
    ...
    _defineProperty(_assertThisInitialized(_this), 'drillUp', () => {
      ...
      const nextView = views[views.indexOf(view) - 1];
      const nextActiveStartDate = (0, _dates.getBegin)(nextView, activeStartDate);
  ...
  _createClass(Calendar, [{
    ...
    value: function renderContent(next) {
      ...
      const { hover } = this;
      const activeStartDate = next ? (0, _dates.getBeginNext)(view, currentActiveStartDate) : (0, _dates.getBegin)(view, currentActiveStartDate);
      ...
      switch (view) {
        case 'century': {
          ...
          return /* #__PURE__ */_react.default.createElement(_CenturyView.default, { formatYear, ...commonProps });
        }

        case 'decade': {
          const _formatYear = this.props.formatYear;
          return /* #__PURE__ */_react.default.createElement(_DecadeView.default, { formatYear: _formatYear, ...commonProps });
        }
        ...
        case 'year': {
          ...
          return /* #__PURE__ */_react.default.createElement(_YearView.default, {
            formatMonth,
            formatMonthYear,
            ...commonProps,
          });
...
const isActiveStartDate = _propTypes.default.instanceOf(Date);

const isLooseValue = _propTypes.default.oneOfType([_propTypes.default.string, _propTypes2.isValue]);
